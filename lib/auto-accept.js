...
/** @param {string} cascadeId @param {number} stepIndex @returns {string} */
 ...
 * @param {number} expectedRange
 * @param {number} requestedFrom
 * @returns {number}
 */
/** @param {number} stepsLength @param {number} expectedRange @param {number} requestedFrom @returns {number} */
