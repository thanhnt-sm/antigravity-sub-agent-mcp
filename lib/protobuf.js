...
// Ported from Antigravity-Deck/src/protobuf.js (ESM, simplified)
...
export function encodeStepsRequest(cascadeId, startIndex, endIndex) {
    const parts = [];
...
export const NESTED_FIELD_MAPS = {
...
export function countBinarySteps(buf) {
...
export function decodeBinarySteps(buf) {
    const reader = protobuf.Reader.create(buf);
    const steps = [];
    while (reader.pos < reader.len) {
        try {
